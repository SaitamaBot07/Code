...
echo "sudo docker compose -f /home/docker_files/docker-compose.yml pull" | sudo tee -a /home/docker_files/script.sh > /dev/null
...
sudo crontab -l; echo "* * * * * /bin/bash /home/docker_files/script.sh" | crontab -