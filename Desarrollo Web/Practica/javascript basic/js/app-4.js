...
const numero6 = new Number(80); //este es ell viejito
console.log(numero6);
console.log('---');
...
console.log(n61); //LOS ARREGLOS EN JS NO SON PRIMITIVOS
console.log(typeof n61);
console.log(Number.parseInt(n61));
console.log(Number.parseFloat(n62));
console.log(Number.parseInt(n63)); //NaN es la representacion de Nulo
console.log(Number.isInteger(n64));
console.log(Number.isInteger(n63));//Boolean
console.log('---');