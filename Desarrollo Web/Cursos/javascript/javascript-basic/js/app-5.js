...
console.log(`Número 1 = ${num1}, Número 2 = ${num2}, Número 3 = ${num3}`); //* asi se pueden poner variables en un print.
console.log('---');
...
console.log(`Número 1 (${num1}) == Número 3 (${num3}) => ${num1 == num3}`);
console.log(`Número 1 (${num1}) == Número 2 (String -> ${num2}) => ${num1 == num2}`); //* esto se debe a que no revisa el tipo de variable solo su valor
...
console.log(`typeof(varn2) => ${typeof varn2}`); //* a pesar de ser null da object  pero es un valor primitivo en realidad
console.log(`varn == varn2 => ${varn == varn2}`); //* esto pasa porque  se supone que los dos son false 
